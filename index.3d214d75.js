...
if (user) {
    ...
    const displayMeilleurscore = async ()=>{
        let allPlayers = await (0, _apicookies.getPlayers)();
        let palyer = window.localStorage.getItem("user");
        let currentPlayer = await (0, _apicookies.getOnePlayer)(JSON.parse(palyer).id);
        console.log(currentPlayer);
        document.getElementById("player").innerText += currentPlayer.name, viewScore.innerHTML = currentPlayer.score || 0;
    ...
    const displayBanque = async ()=>{
        ...
        //let numberOfBuy = []
        if (numberOfBuy.length === 0) messages.parentNode.style.display = "none";
  ...
  <button type="button" class=" btn btn-danger text-danger  m-2 btn-losange" id="btn-reset">reset</button>
        ...
        for(let i = 2; i < 6; i++){
            ...
            if (i < 3) allButtons[i].addEventListener("click", ()=>{
                ...
                (0, _apicookies.updatecurrentPlayer)(score, multipli[i - 2]);
        ...
        btnAuto.addEventListener("click", ()=>{
            ...
            //update score and cost
            (0, _apicookies.updatecurrentPlayer)(score, multipli[2]);
            getAllMultiplicateur();
            messages.innerHTML = "";
            displayBanque();
        });
        ...
        btnBonus.addEventListener("click", ()=>{
            ...
            //update score and cost
            (0, _apicookies.updatecurrentPlayer)(score, multipli[3]);
            getAllMultiplicateur();
            messages.innerHTML = "";
            displayBanque();
        });
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"03kzI":[function(require,module,exports) {
//login function
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "login", ()=>login);
parcelHelpers.export(exports, "register", ()=>register);
parcelHelpers.export(exports, "getPlayers", ()=>getPlayers);
parcelHelpers.export(exports, "getOnePlayer", ()=>getOnePlayer);
parcelHelpers.export(exports, "updatecurrentPlayer", ()=>updatecurrentPlayer);
parcelHelpers.export(exports, "resetPlayer", ()=>resetPlayer);
parcelHelpers.export(exports, "updateOnePlayer", ()=>updateOnePlayer);
...
const getPlayers = async ()=>{
    ...
    if (dataplayers) return dataplayers;
    else return [];
};
...
const updatecurrentPlayer = async (score, multiplicateur)=>{
    let palyer = window.localStorage.getItem("user");
...
const updateOnePlayer = async (currentPlayer)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2LIPM":[function(require,module,exports) {
/*! *****************************************************************************
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire3ece")
